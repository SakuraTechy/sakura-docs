<template>
  ...
  <script lang="ts" setup>
    ...
    if (type.value && type.value == 'gitalk') {
      gitalk = new Gitalk({
        clientID: 'Ov23li******YW7iZ',
        clientSecret: 'eb821b4f85c54******478aeea0f37f668232',
        repo: 'Sakura.******.Platform.Docs',
        owner: 'Sak******echy',
        admin: ['hag******20'],
        labels: ['GitTalk'],
        ...
        // 默认: https://github.com/login/oauth/access_token
        // https://prohibitorum.top/7cc2c97a15b4#%E9%83%A8%E7%BD%B2%E5%88%B0-Vercel-%E4%B8%8A
